...
public class Arm extends SubsystemBase {
  ...
  public static double ArmRequestedState;
  public static double ArmCurrentState;
  ...
  public void periodic() {
    ...
    SmartDashboard.putBoolean ( "Is At Setpoint", armAtSetpoint());
  ...
  public void requestPosition(double requestedPosition){
   desiredPosition = requestedPosition; 
  }
